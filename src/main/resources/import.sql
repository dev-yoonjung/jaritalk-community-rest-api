...
INSERT INTO user (create_time, update_time, account_id, account_type, nickname, quit) VALUES (NOW(), NOW(), 'lessorB', 'LESSOR', '임차인B', true);
...
INSERT INTO user (create_time, update_time, account_id, account_type, nickname, quit) VALUES (NOW(), NOW(), 'realtorB', 'REALTOR', '공인중개사B', true);
INSERT INTO user (create_time, update_time, account_id, account_type, nickname, quit) VALUES (NOW(), NOW(), 'lesseeA', 'LESSEE', '임대인A', false);
INSERT INTO user (create_time, update_time, account_id, account_type, nickname, quit) VALUES (NOW(), NOW(), 'lesseeB', 'LESSEE', '임대인B', true);